...
const ScratchCard = ({ txHash, sendEth, mintNft, sendToken, burnToken, loading, isBurnFailed }) => {
    ...
    const rewards = [
        ...
        { id: 2, text: "200 Token", color: "bg-blue-500" },
        { id: 3, text: "50 Token", color: "bg-green-500" },
        { id: 4, text: "NFT", color: "bg-yellow-500" },
        { id: 5, text: "75 Token", color: "bg-green-500" },
        { id: 6, text: "100 Token", color: "bg-green-500" },
    ];
    ...
    const handleScratch = (e) => {
        ...
        if (!hasRevealed) {
            ...
            const scratchPercentage = (transparentCount / (imageData.data.length / 4)) * 100;
            ...
            if (scratchPercentage > 40 && !hasTriggeredRef.current) {
                ...
                else if (result.text === "200 Token") {
                    sendToken("200");
                }
                else if (result.text === "50 Token") {
                    sendToken("50");
                }
                else if (result.text === "75 Token") {
                    sendToken("75");
                }
                else if (result.text === "100 Token") {
                    sendToken("100");
                }
            }
        }
    ...
    const resetScratchCard = () => {
        setIsStarted(true);
        if (balance < 100) {
            toast.dark("Not enough balance to try again (need at least 100 tokens)");
            return;
        }
        burnToken();
        ...
        <div className="flex flex-col items-center justify-center p-4">
            ...
            >
                ...
                <div className="absolute inset-0 flex items-center justify-center rounded-lg">
                    <div className={`p-4 rounded-lg text-center ${result.color} text-white font-bold`}>
